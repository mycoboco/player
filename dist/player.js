...
var Player = (function (_EventEmitter) {
  ...
  _createClass(Player, [{
    ...
    value: function next() {
      ...
      var nextIndex = !current ? 0 : this.options.shuffle ? (0, _utils.chooseRandom)(_underscore2['default'].difference(list, [current._id])) : current._id + 1;
    ...
    value: function previous() {
      var list = this._list;
      var current = this.playing;
      var previousIndex = this.options.shuffle ? (0, _utils.chooseRandom)(_underscore2['default'].difference(list, [current._id])) : current._id - 1;
